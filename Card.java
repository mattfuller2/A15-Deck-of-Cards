...
public class Card implements Comparable<Card> {
	...
	/**
	 * Checks if the given card is equal to this card (same suit and face value).
	 *
	 ...
	 * @return -1 if this Card is less than other Card, +1 if this Card is greater than other Card,
	 *         0 if Card values are equal
	 */
	@Override
